...
|--------|------|------|-------|
| POST | `/relay/register` | `{deviceId, model, androidVersion, appVersion, installed[], missing[], monitorRunning, batteryOptimized, inUse, screenOn, lastUnlock, ringerMode, appState, appStateAt}` | `deviceId` 4-128 chars `[a-zA-Z0-9._-]` |
